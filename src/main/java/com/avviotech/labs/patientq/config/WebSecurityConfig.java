...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				.authorizeRequests()
				.antMatchers("/patient-records/**","/plugins/**", "/bootstrap/**", "/admin/**","/tabs/**" ,"/css/**","/datarc/**","/ertabs/**", "/js/**","/home","/registerUser","/reservationconfirmation","/submitUser","/book-appointment","/patient-reservation",
						"/less/**", "/public/rest/**").permitAll()
				.antMatchers("/index/**").hasAnyRole("USER").anyRequest()
				.authenticated().and().formLogin().loginPage("/loginAction")
